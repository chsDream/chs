	...
	<view class="about">
		<view class="content">
			<view class="qrcode">
				...
				<uni-view data-v-d49e1a2a class="uni-link uni-center uni-common-mt">
						调试界面
					<!-- <input type="text" class="text" name="value_2" id="value_2" x-webkit-speech lang="zh-CN"> -->
					
						<input type=”text” speech x-webkit-speech placeholder="测试语音"/>
					</uni-view>
				...
				<view class="uni-common-mt">
					<view class="uni-form-item uni-column">
						...
						<input class="uni-input" focus   speech x-webkit-speech   placeholder="自动获得焦点" />
					</view>
				</view>	
				
				
				<uni-view data-v-d49e1a2a class="uni-link uni-center uni-common-mt">点击这里返回顶部</uni-view>
